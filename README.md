...
- `workspace-guard.ts` confirms commands that may deploy remotely, write outside the current repository, or write in a dirty workspace. OMS repositories are excluded.
